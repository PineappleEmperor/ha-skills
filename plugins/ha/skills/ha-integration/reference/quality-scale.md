...
**Canonical rule set — a snapshot; rules change. Re-verify per the *Freshness* table in `reference/freshness.md`.** All must appear in `quality_scale.yaml`:
